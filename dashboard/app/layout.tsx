...
export default function RootLayout({
  ...
  // 2. Daftar modul CRM dengan Komponen Ikon SVG (semua warna merah brand)
  const menuItems = [
    { 
            ...
            <div className="space-y-6 overflow-y-auto max-h-[80vh] pr-1 scrollbar-none">
              ...
              <div className="pb-4 border-b border-gray-100 flex items-center justify-between min-h-[65px]">
                ...
                <button 
                  ...
                  className={`p-2 rounded-xl bg-gray-50 hover:bg-red-50 text-[#C92C1E] hover:text-[#C92C1E] border border-gray-200/60 hover:border-red-200 transition-all duration-200 cursor-pointer flex items-center justify-center ${
